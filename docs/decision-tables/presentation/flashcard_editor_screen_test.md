...
| --- | --- | --- | --- | --- | --- |
| DT1 | initial render | create screen opens on a deck | render the screen | front/back are present, save is disabled, and the optional section is collapsed | C0+C1 |
...
| DT5 | save success | front/back/example/hint/pronunciation are filled with trimmed input | tap Save | the repository receives trimmed values, a success snackbar appears, and the screen pops | C0+C1 |
