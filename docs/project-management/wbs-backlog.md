...
| P0.3 | ~~4.2.1~~ / 4.2.2 / 4.2.3 / 4.2.4 | ~~Session creation BE~~ ✅ **DONE 2026-06-21** (transactional session+items insert) + no-silent-resume gate + resume/start-over FE + batch limit | |
