...
| Priority | WBS | Item |
|---|---|---|
| P1.8 | 4.5.4–4.5.9 | Match / Guess / Fill modes (BE + FE) — ~~4.5.6 Guess BE~~ ✅ + ~~4.5.8 Fill BE~~ ✅ **DONE 2026-06-21** (Guess `buildOptions` 5-option selection; Fill `evaluate` mark-correct/hint-taint → recovered); Match BE (4.5.4) + all mode FE remain |
...
preview · 6.7.1 file picker · ~~6.9.1~~ ✅ **DONE 2026-06-21** (structured-text separators BE).
