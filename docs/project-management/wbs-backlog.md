...
|---|---|---|---|
| P0.1 | **4.0.1** | Study persistence schema + repo skeleton (ENABLER B1) | Schema/migration — gates all of §4. **Needs schema approval.** |
| P0.2 | 4.1.1 / 4.1.2 | Study entry eligibility BE + entry FE | Resolve scope, empty-state matrix. |
| P0.3 | 4.2.1 / 4.2.2 / 4.2.3 / 4.2.4 | Session creation BE + no-silent-resume gate + resume/start-over FE + batch limit | |
| P0.4 | 4.3.1 / 4.3.2 | Session item loading BE + review shell FE | |
