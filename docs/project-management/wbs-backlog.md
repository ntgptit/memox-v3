...
| P1.2 | 7.4.1 / 7.4.2 / ~~7.1.1~~ / ~~7.2.1~~ / ~~7.3.1~~ | Progress read models + ~~due~~/~~box~~/~~stats~~ queries | ~~7.1.1 Due~~ + ~~7.2.1 Box~~ + ~~7.3.1 Stats~~ ✅ **DONE 2026-06-21** (`loadDueSummary`, `loadBoxDistribution`, `loadStudyStatistics`). Combined read model (7.4.x) remains — composes these three. |
