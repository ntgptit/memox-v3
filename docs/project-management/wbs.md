...
| 2.4.1 | Content management | Folder Move BE V1 | BE | Cycle-safe move + move-target query + tests | Specified | 2.1.1 | `lib/domain/usecases/folder/move_folder_usecase.dart`, `lib/domain/usecases/folder/get_folder_move_targets_usecase.dart` | TBD | Implement |
