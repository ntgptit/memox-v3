...
| --- | --- | --- | --- |
| `12652e7` | 2026-06-15 | 8.4.1, 8.4.3 | TTS service BE: domain + data + DI + notifier; schema v9 (tts_settings); auto-play on reveal in recall mode; speak-front in fill mode; normalization/use-case/migration tests |
