...
| --- | --- | --- | --- |
| `TBD` | 2026-06-19 | 1.1.4 | l10n baseline: add `app_vi.arb`, wire `gen-l10n` output into `MaterialApp` (`localizationsDelegates`/`supportedLocales`/`onGenerateTitle`), en/vi `AppLocalizations` tests; flip 1.1.4 Specified→Implemented |
