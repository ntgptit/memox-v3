...
| --- | --- | --- | --- |
| `TBD` | 2026-06-19 | 1.1.3 | Routing baseline: GoRouter shell with top-level destinations (`/home`/`/library`/`/progress`/`/settings`) from navigation-flow, `/`→Library `rootRedirect`, `RouteNames`/`RoutePaths`/`RouteDefaults` constants, `RoutePlaceholder` placeholder discipline; router widget tests; flip 1.1.3 Specified→Implemented |
