...
| 2.7.1 | Content management | Deck Create BE V1 | BE | Validated deck create (folder-owned, mode lock) + tests | Specified | 2.6.1 | `lib/domain/usecases/deck/create_deck_usecase.dart`, `test/data/repositories/folder_repository_impl_test.dart` | TBD | Implement |
...
| 2.8.1 | Content management | Deck Rename BE V1 | BE | Validated deck rename use case + repo method + tests | Specified | 2.7.1 | `lib/domain/usecases/deck/rename_deck_usecase.dart`, `lib/data/repositories/folder_repo_impl_mutation_helpers.dart`, `lib/data/repositories/folder_repository_impl.dart`, `test/data/repositories/folder_repository_impl_test.dart`, `test/domain/usecases/deck/rename_deck_usecase_test.dart` | TBD | Implement |
...
| 2.9.1 | Content management | Deck Delete BE V1 | BE | Transactional deck delete with flashcard/progress cleanup + tests | Specified | 2.7.1 | `lib/domain/usecases/deck/delete_deck_usecase.dart` | TBD | Implement |
...
| 2.10.1 | Content management | Deck Reorder BE V1 | BE | `sort_order` reorder use case + tests | Specified | 2.7.1 | `lib/domain/usecases/deck/reorder_decks_usecase.dart`, `lib/data/repositories/folder_repo_impl_mutation_helpers.dart`, `lib/data/repositories/folder_repository_impl.dart`, `test/data/repositories/folder_repository_impl_test.dart`, `test/domain/usecases/deck/reorder_decks_usecase_test.dart` | TBD | Implement |
| 2.10.2 | Content management | Deck Reorder FE V1 | FE | Manual reorder UI | Specified | 2.10.1 | TBD | TBD | Wire to BE; widget tests |
| 2.11.1 | Content management | Flashcard Create BE V1 | BE | Front/back required-after-trim validation, optional fields, default SRS progress + tests | Specified | 1.1.5 | `lib/domain/usecases/flashcard/create_flashcard_usecase.dart`, `test/domain/usecases/flashcard/create_flashcard_usecase_test.dart` | TBD | Implement |
...
| 2.12.1 | Content management | Flashcard Update BE V1 | BE | Validated update use case + tests | Specified | 2.11.1 | `lib/domain/usecases/flashcard/update_flashcard_usecase.dart`, `test/domain/usecases/flashcard/update_flashcard_usecase_test.dart` | TBD | Implement |
...
| 2.13.1 | Content management | Flashcard Delete BE V1 | BE | Delete use case with cascade per persistence rules | Specified | 2.11.1 | `lib/domain/usecases/flashcard/delete_flashcard_usecase.dart` | TBD | Implement |
...
| 2.14.1 | Content management | Flashcard Reorder BE V1 | BE | `sort_order` reorder use case + repo method | Specified | 2.11.1 | `lib/domain/usecases/flashcard/reorder_flashcards_usecase.dart`, `lib/data/repositories/flashcard_repository_impl.dart`, `test/data/repositories/flashcard_repository_impl_test.dart` | TBD | Implement |
...
| 2.15.1 | Content management | Flashcard Tags BE V1 | BE | Tag validation (trim/lowercase/dedupe), `flashcard_tags` table + migration | Specified | 1.1.5 | `lib/domain/tag/tag_validator.dart`, `lib/data/datasources/local/migrations/v3_add_flashcard_tags.dart` | TBD | Implement |
...
| 2.16.1 | Content management | Parent-child validation BE | BE | Deck must belong to folder; flashcard must belong to deck (non-null FK + repo checks) | Specified | 1.1.5 | `lib/data/datasources/local/drift/**` (non-null `folder_id`/`deck_id`) | TBD | Implement |
...
| 2.19.1 | Content management | Deck Move BE V1 | BE | Move deck to another folder (mode validation, sort append, source unlock) + tests | Specified | 2.7.1 | `lib/domain/usecases/deck/move_deck_usecase.dart`, `lib/data/repositories/folder_repo_impl_mutation_helpers.dart`, `lib/data/repositories/folder_repository_impl.dart`, `test/data/repositories/folder_repository_impl_move_deck_test.dart`, `test/domain/usecases/deck/move_deck_usecase_test.dart` | TBD | Implement |
...
| 3.4.1 | Library | Flashcard list load BE | BE | `watchFlashcardList` stream + tests | Specified | 2.11.1 | `lib/domain/usecases/flashcard/watch_flashcard_list_usecase.dart`, `test/data/repositories/flashcard_repository_impl_test.dart` | TBD | Implement |
...
| 3.5.1 | Library | Global search BE | BE | Search use case + repo, LIKE escaping, ranking, min-query/debounce contract + tests | Specified | 1.1.5 | `lib/domain/usecases/search/global_search_usecase.dart`, `test/data/repositories/search_repository_impl_test.dart` | TBD | Implement |
...
| 3.7.1 | Library | Folder/deck due+card counts BE | BE | Counts stream from DB; due excludes buried/suspended | Specified | 3.2.1 | `lib/data/datasources/local/drift/folder_queries.drift`, `lib/data/repositories/folder_repository_impl.dart`, `test/data/repositories/folder_deck_due_counts_test.dart`, `test/data/repositories/folder_repository_impl_test.dart` | TBD | Implement |
