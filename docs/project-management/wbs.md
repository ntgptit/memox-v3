...
| 4.5.8 | Study/SRS | Fill mode BE V1 | BE | Strict character match, terminal persistence, mark-correct override, hint taint + tests | Specified | 4.5.1 | `docs/business/study/study-flow.md` | TBD | Implement BE strategy against the one-terminal-attempt contract; fill does not depend on 4.4.3 append-attempt re-grade |
