# Claude Code Task Prompt — WBS 2.2.1: Folder Rename BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Validated rename use case + repo + tests
...
**WBS ID:** `2.2.1`
**Evidence / Source:** `lib/domain/usecases/folder/rename_folder_usecase.dart`, `test/data/repositories/folder_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.2.1 | {one-line summary of what was implemented} |
```
