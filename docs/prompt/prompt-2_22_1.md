# Claude Code Task Prompt — WBS 2.22.1: Folder color/icon schema + BE

**Generated:** 2026-06-20
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Add `folders.color` + `folders.icon` columns (migration v+1), extend `Folder` entity/mapper + `createRootFolder`/`createSubfolder`/`renameFolder` to carry them; defaults + schema/migration tests
...
```
| `<8-char-hash>` | 2026-06-20 | 2.22.1 | {one-line summary of what was implemented} |
```
