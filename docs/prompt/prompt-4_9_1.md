# Claude Code Task Prompt — WBS 4.9.1: Protected active-session exit FE

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Exit confirmation; confirmed exit keeps session resumable
...
**WBS ID:** `4.9.1`
**Evidence / Source:** `lib/presentation/features/study/screens/study_session_screen.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.9.1 | {one-line summary of what was implemented} |
```
