# Claude Code Task Prompt — WBS 1.2.2: Core widget kit — navigation & app bar

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `MxAppBar`, `MxBottomNav`, `MxBreadcrumb`; selected/elevated states; goldens

## ⚠️ Dependency warnings

⚠️  Dependency `1.1.2` (Theme tokens + design-system baseline) is **Specified** — build it first.
...
**WBS ID:** `1.2.2`
**Evidence / Source:** `lib/presentation/shared/widgets/navigation/**`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.2.2 | {one-line summary of what was implemented} |
```
