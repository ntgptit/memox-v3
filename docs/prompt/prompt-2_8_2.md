# Claude Code Task Prompt — WBS 2.8.2: Deck Rename FE V1

**Generated:** 2026-06-20
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Rename entry in deck actions sheet + dialog + states

## ⚠️ Dependency warnings

⚠️  Dependency `2.8.1` (Deck Rename BE V1) is **Implemented (2026-06-20)** — build it first.
...
**WBS ID:** `2.8.2`
**Evidence / Source:** `lib/presentation/features/flashcards/widgets/deck_actions_sheet.dart` (sheet exists; rename action TBD)
...
```
| `<8-char-hash>` | 2026-06-20 | 2.8.2 | {one-line summary of what was implemented} |
```
