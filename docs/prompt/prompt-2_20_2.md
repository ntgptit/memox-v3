# Claude Code Task Prompt — WBS 2.20.2: Manual duplicate soft-warning FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Non-blocking "save anyway?" confirm in editor

## ⚠️ Dependency warnings

⚠️  Dependency `2.20.1` (Manual duplicate soft-warning BE V1) is **Specified** — build it first.
...
**WBS ID:** `2.20.2`
**Evidence / Source:** `docs/business/flashcard/flashcard-management.md` §Rules
...
```
| `<8-char-hash>` | 2026-06-19 | 2.20.2 | {one-line summary of what was implemented} |
```
