# Claude Code Task Prompt — WBS 4.10.1: Cancel/discard session BE

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `cancelStudySession` used by transactional start-over
...
**WBS ID:** `4.10.1`
**Evidence / Source:** `lib/domain/study/ports/study_repo.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.10.1 | {one-line summary of what was implemented} |
```
