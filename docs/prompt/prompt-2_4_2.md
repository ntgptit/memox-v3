# Claude Code Task Prompt — WBS 2.4.2: Folder Move FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Move picker sheet + states

## ⚠️ Dependency warnings

⚠️  Dependency `2.4.1` (Folder Move BE V1) is **Specified** — build it first.
...
**WBS ID:** `2.4.2`
**Evidence / Source:** `lib/presentation/features/folders/widgets/folder_move_picker_sheet.dart`, `test/presentation/features/folders/folder_move_picker_sheet_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.4.2 | {one-line summary of what was implemented} |
```
