# Claude Code Task Prompt — WBS 4.11.2: In-session bury/suspend action BE

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Bury/suspend current card: set fields, no attempt, preserve SRS + tests
...
```
| `<8-char-hash>` | 2026-06-20 | 4.11.2 | {one-line summary of what was implemented} |
```
