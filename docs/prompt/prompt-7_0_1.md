# Claude Code Task Prompt — WBS 7.0.1: **Card-history schema (ENABLER — B4)**

**Generated:** 2026-06-20
**Flow:** Progress | **Layer:** BE | **Status:** Blocked

**Deliverable:**
> `card_events` table (created/edited/reset events, FK→flashcards) + `flashcard_progress.last_reset_at` column + `study_attempts.duration_ms` column; migration v+1 + schema/migration tests; no read logic yet (lands in 7.6.1)
...
```
| `<8-char-hash>` | 2026-06-20 | 7.0.1 | {one-line summary of what was implemented} |
```
