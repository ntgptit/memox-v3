# Claude Code Task Prompt — WBS 2.9.1: Deck Delete BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Transactional deck delete with flashcard/progress cleanup + tests
...
**WBS ID:** `2.9.1`
**Evidence / Source:** `lib/domain/usecases/deck/delete_deck_usecase.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.9.1 | {one-line summary of what was implemented} |
```
