# Claude Code Task Prompt — WBS 4.7.2: Result screen FE

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `/library/study/session/:sessionId/result` with fallback states

## ⚠️ Dependency warnings

⚠️  Dependency `4.7.1` (Result summary BE) is **Specified** — build it first.
...
**WBS ID:** `4.7.2`
**Evidence / Source:** `lib/presentation/features/study/screens/study_result_screen.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 4.7.2 | {one-line summary of what was implemented} |
```
