# Claude Code Task Prompt — WBS 4.1.3: Deck study CTA FE V1

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Study-entry section on Flashcard List: Study deck + Today CTAs routing through the gate
...
```
| `<8-char-hash>` | 2026-06-19 | 4.1.3 | {one-line summary of what was implemented} |
```
