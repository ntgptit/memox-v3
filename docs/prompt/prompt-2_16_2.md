# Claude Code Task Prompt — WBS 2.16.2: Parent-child guard FE

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Invalid actions prevented in UI with controlled error, not crash

## ⚠️ Dependency warnings

⚠️  Dependency `2.16.1` (Parent-child validation BE) is **Specified** — build it first.
...
**WBS ID:** `2.16.2`
**Evidence / Source:** feature screens use `Result`/failure mapping
...
```
| `<8-char-hash>` | 2026-06-19 | 2.16.2 | {one-line summary of what was implemented} |
```
