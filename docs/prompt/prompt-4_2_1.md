# Claude Code Task Prompt — WBS 4.2.1: Session creation BE

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Transactional `study_sessions` + `study_session_items` insert + tests
...
**WBS ID:** `4.2.1`
**Evidence / Source:** `lib/data/repositories/study_repo_impl_study_session.dart`, `test/data/repositories/study_repository_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.2.1 | {one-line summary of what was implemented} |
```
