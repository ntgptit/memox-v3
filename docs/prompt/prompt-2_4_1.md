# Claude Code Task Prompt — WBS 2.4.1: Folder Move BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Cycle-safe move + move-target query + tests
...
**WBS ID:** `2.4.1`
**Evidence / Source:** `lib/domain/usecases/folder/move_folder_usecase.dart`, `lib/domain/usecases/folder/get_folder_move_targets_usecase.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.4.1 | {one-line summary of what was implemented} |
```
