# Claude Code Task Prompt — WBS 2.6.1: Folder content-mode guard BE

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Parent holds subfolders or decks, never both; enforced outside UI
...
**WBS ID:** `2.6.1`
**Evidence / Source:** `lib/domain/types/content_mode.dart`, `lib/data/repositories/folder_repo_impl_mutation_helpers.dart`, `test/data/repositories/folder_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.6.1 | {one-line summary of what was implemented} |
```
