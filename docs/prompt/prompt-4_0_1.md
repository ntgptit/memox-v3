# Claude Code Task Prompt — WBS 4.0.1: **Study persistence schema + repo skeleton (ENABLER — B1)**

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `study_sessions` + `study_session_items` + `study_attempts` Drift tables (FK chain, indexes) + migration v+1 + schema test; `StudyRepo` domain port + impl skeleton (no business logic yet) + DI wiring; schema/migration contracts updated
...
**WBS ID:** `4.0.1`
**Evidence / Source:** `lib/data/datasources/local/drift/**`, `lib/data/datasources/local/migrations/**`, `lib/domain/study/ports/study_repo.dart`, `docs/database/schema-contract.md`, `docs/database/migration-contract.md`, `test/data/migrations/**`
...
```
| `<8-char-hash>` | 2026-06-20 | 4.0.1 | {one-line summary of what was implemented} |
```
