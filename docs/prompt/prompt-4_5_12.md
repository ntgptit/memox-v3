# Claude Code Task Prompt — WBS 4.5.12: Mode-chain persistence backbone BE

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `StudyFlow` type + `StudyFlowPlan` (ordered phases) + `StudyFlowResolver`; schema v10 (`study_sessions.study_flow`, `current_mode`) + migration/test; persist flow + firstMode at create (new deck/folder → `new_full_cycle`). Backbone only — FE consumption + per-phase advance pending 4.5.13
...
```
| `<8-char-hash>` | 2026-06-20 | 4.5.12 | {one-line summary of what was implemented} |
```
