# Claude Code Task Prompt — WBS 6.7.1: File picker entry FE

**Generated:** 2026-06-19
**Flow:** Import | **Layer:** FE | **Status:** Specified

**Deliverable:**
> File selection (UTF-8 CSV file) replacing paste-only input
...
```
| `<8-char-hash>` | 2026-06-19 | 6.7.1 | {one-line summary of what was implemented} |
```
