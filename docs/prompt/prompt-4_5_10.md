# Claude Code Task Prompt — WBS 4.5.10: Daily new limit BE V1

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Cap new-card eligibility at `dailyNewLimit` (default 20) per local day; due review cards remain eligible; daily usage is derived from persisted new-card session items

## ⚠️ Dependency warnings

⚠️  Dependency `4.5.1` (Study mode strategy V1 BE) is **Specified** — build it first.
...
**WBS ID:** `4.5.10`
**Evidence / Source:** `docs/business/srs/srs-review.md` §Rules, `docs/business/study/study-flow.md` §Rules, `lib/data/repositories/study_repo_impl_study_session.dart`, `test/data/repositories/study_repository_daily_new_limit_test.dart`, `test/data/repositories/study_repository_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.5.10 | {one-line summary of what was implemented} |
```
