# Claude Code Task Prompt — WBS 6.6.1: Duplicate detection BE V1

**Generated:** 2026-06-19
**Flow:** Import | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Case-insensitive front/back dup check vs file + existing deck + tests
...
```
| `<8-char-hash>` | 2026-06-19 | 6.6.1 | {one-line summary of what was implemented} |
```
