# Claude Code Task Prompt — WBS 9.7: State-coverage gate

**Generated:** 2026-06-19
**Flow:** Quality | **Layer:** Test | **Status:** Ongoing

**Deliverable:**
> Loading/empty/error/no-results states on every screen
...
**WBS ID:** `9.7`
**Evidence / Source:** shared `Mx*` state widgets
...
```
| `<8-char-hash>` | 2026-06-19 | 9.7 | {one-line summary of what was implemented} |
```
