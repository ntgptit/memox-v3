# Claude Code Task Prompt — WBS 4.5.11: Recall mode FE V1

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Timed reveal/self-grade recall shell with 20s countdown, timeout reveal, and edit-pause resume

## ⚠️ Dependency warnings

⚠️  Dependency `4.5.2` (Review mode BE V1) is **Specified** — build it first.
⚠️  Dependency `4.4.1` (Submit self-grade BE) is **Specified** — build it first.
...
**WBS ID:** `4.5.11`
**Evidence / Source:** `lib/presentation/features/study/screens/study_session_screen.dart`, `lib/presentation/features/study/widgets/study_session_recall_mode_view.dart`, `lib/presentation/features/study/viewmodels/study_session_recall_viewmodel.dart`, `test/presentation/features/study/study_session_screen_test.dart`, `docs/wireframes/16-study-session-recall.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.5.11 | {one-line summary of what was implemented} |
```
