# Claude Code Task Prompt — WBS 2.21.1: Folder delete blast-radius confirm FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Delete dialog shows subtree counts; stronger confirm above threshold

## ⚠️ Dependency warnings

⚠️  Dependency `2.3.2` (Folder Delete FE V1) is **Specified** — build it first.
...
**WBS ID:** `2.21.1`
**Evidence / Source:** `docs/business/folder/folder-management.md` §Rules
...
```
| `<8-char-hash>` | 2026-06-19 | 2.21.1 | {one-line summary of what was implemented} |
```
