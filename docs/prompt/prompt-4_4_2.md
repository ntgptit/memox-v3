# Claude Code Task Prompt — WBS 4.4.2: Self-grade FE (Forgot / Got it)

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Grading controls + answered-state advancement
...
**WBS ID:** `4.4.2`
**Evidence / Source:** `test/presentation/features/study/study_session_review_viewmodel_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.4.2 | {one-line summary of what was implemented} |
```
