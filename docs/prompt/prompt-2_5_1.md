# Claude Code Task Prompt — WBS 2.5.1: Folder Reorder BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `sort_order` reorder use case + DAO + tests

## ⚠️ Dependency warnings

⚠️  Dependency `2.1.1` (Folder Create BE V1) is **Specified** — build it first.
...
**WBS ID:** `2.5.1`
**Evidence / Source:** `lib/domain/usecases/folder/reorder_folders_usecase.dart`, `lib/data/repositories/folder_repo_impl_mutation_helpers.dart`, `lib/data/repositories/folder_repository_impl.dart`, `test/data/repositories/folder_repository_impl_test.dart`, `test/domain/usecases/folder/reorder_folders_usecase_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.5.1 | {one-line summary of what was implemented} |
```
