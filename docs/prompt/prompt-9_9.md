# Claude Code Task Prompt — WBS 9.9: Guard/analyzer/test gate

**Generated:** 2026-06-19
**Flow:** Quality | **Layer:** Test | **Status:** Ongoing

**Deliverable:**
> `dart fix` + `dart format` + `flutter analyze` + targeted tests (+ guard when present)
...
**WBS ID:** `9.9`
**Evidence / Source:** `docs/checklist/implementation-checklist.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 9.9 | {one-line summary of what was implemented} |
```
