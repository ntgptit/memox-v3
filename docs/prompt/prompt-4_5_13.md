# Claude Code Task Prompt — WBS 4.5.13: Per-phase chain runtime (advance + cross-phase finalization + FE)

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE+FE | **Status:** Specified

**Deliverable:**
> Consume `current_mode`; `AdvanceStudyPhaseUseCase`; unify finalization to aggregate all-mode attempts + derived match result per item; session screen drives/advances phases (intermediate advance, last finalizes)

## ⚠️ Dependency warnings

⚠️  Dependency `4.5.12` (Mode-chain persistence backbone BE) is **Specified** — build it first.
...
**WBS ID:** `4.5.13`
**Evidence / Source:** `docs/business/study/study-flow.md`, `docs/business/srs/srs-review.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.5.13 | {one-line summary of what was implemented} |
```
