# Claude Code Task Prompt — WBS 4.10.2: Resume expiry anchor `updated_at`

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> 30-day resumable filter anchors on `updated_at` (activity), not `started_at`

## ⚠️ Dependency warnings

⚠️  Dependency `4.2.1` (Session creation BE) is **Specified** — build it first.
...
### Task-specific
- `docs/contracts/usecase-contracts/srs.md`
...
**WBS ID:** `4.10.2`
**Evidence / Source:** `docs/business/resume/resume-session.md` §Auto-expiry, `lib/data/datasources/local/daos/study_session_dao.dart`, `lib/data/repositories/study_repo_record_answer.dart`, `test/data/repositories/study_repository_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 4.10.2 | {one-line summary of what was implemented} |
```
