# Claude Code Task Prompt — WBS 2.14.2: Flashcard Reorder FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Reorder UI in flashcard list

## ⚠️ Dependency warnings

⚠️  Dependency `2.14.1` (Flashcard Reorder BE V1) is **Specified** — build it first.
...
```
| `<8-char-hash>` | 2026-06-19 | 2.14.2 | {one-line summary of what was implemented} |
```
