# Claude Code Task Prompt — WBS 2.2.2: Folder Rename FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Rename dialog via folder actions sheet

## ⚠️ Dependency warnings

⚠️  Dependency `2.2.1` (Folder Rename BE V1) is **Specified** — build it first.
...
**WBS ID:** `2.2.2`
**Evidence / Source:** `lib/presentation/features/folders/widgets/library_folder_actions_sheet.dart`, `test/presentation/features/folders/library_folder_actions_sheet_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.2.2 | {one-line summary of what was implemented} |
```
