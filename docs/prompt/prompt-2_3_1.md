# Claude Code Task Prompt — WBS 2.3.1: Folder Delete BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Transactional cascade delete per persistence rules + tests
...
**WBS ID:** `2.3.1`
**Evidence / Source:** `lib/domain/usecases/folder/delete_folder_usecase.dart`, `lib/data/repositories/folder_repo_impl_mutation_helpers.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.3.1 | {one-line summary of what was implemented} |
```
