# Claude Code Task Prompt — WBS 5.6.2: Recent decks section FE

**Generated:** 2026-06-19
**Flow:** Dashboard | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Recent-decks section (top 3, card/due/last-studied, deck-row → flashcard list) + Library shortcut
...
**WBS ID:** `5.6.2`
**Evidence / Source:** `lib/presentation/features/dashboard/screens/dashboard_screen.dart` (`_DashboardRecentDecksSection`), `test/presentation/features/dashboard/dashboard_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 5.6.2 | {one-line summary of what was implemented} |
```
