# Claude Code Task Prompt — WBS 5.7.1: Start new learning CTA FE

**Generated:** 2026-06-20
**Flow:** Dashboard | **Layer:** FE | **Status:** Specified

**Deliverable:**
> New-learning card with never-studied count badge → global new-cards study entry (deck/folder scope picker deferred)

## ⚠️ Dependency warnings

⚠️  Dependency `5.6.1` (Recent decks + new-card highlights BE) is **Specified** — build it first.
...
- `docs/wireframes/05-library-folder-detail.md`
...
**WBS ID:** `5.7.1`
**Evidence / Source:** `lib/presentation/features/dashboard/screens/dashboard_screen.dart` (`_DashboardNewLearningCard`), `test/presentation/features/dashboard/dashboard_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 5.7.1 | {one-line summary of what was implemented} |
```
