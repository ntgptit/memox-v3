# Claude Code Task Prompt — WBS 5.1.2: Continue Studying card FE

**Generated:** 2026-06-19
**Flow:** Dashboard | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Resume card with Continue CTA; hidden when none

## ⚠️ Dependency warnings

⚠️  Dependency `5.1.1` (Continue Studying summary BE) is **Specified** — build it first.
...
**WBS ID:** `5.1.2`
**Evidence / Source:** `lib/presentation/features/dashboard/screens/dashboard_screen.dart`, `test/presentation/features/dashboard/dashboard_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 5.1.2 | {one-line summary of what was implemented} |
```
