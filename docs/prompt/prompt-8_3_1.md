# Claude Code Task Prompt — WBS 8.3.1: Tag management BE V1

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Distinct tag list/count/search + transactional rename/merge/delete over `flashcard_tags` + tests
...
```
| `<8-char-hash>` | 2026-06-19 | 8.3.1 | {one-line summary of what was implemented} |
```
