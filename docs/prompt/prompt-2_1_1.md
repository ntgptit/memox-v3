# Claude Code Task Prompt — WBS 2.1.1: Folder Create BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Validated root/subfolder create use cases + repo + DAO + tests
...
**WBS ID:** `2.1.1`
**Evidence / Source:** `lib/domain/usecases/folder/create_root_folder_usecase.dart`, `lib/domain/usecases/folder/create_subfolder_usecase.dart`, `test/data/repositories/folder_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.1.1 | {one-line summary of what was implemented} |
```
