# Claude Code Task Prompt — WBS 4.5.7: Guess mode FE V1

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Guess UI with auto-advance countdown

## ⚠️ Dependency warnings

⚠️  Dependency `4.5.6` (Guess mode BE V1) is **Specified** — build it first.
...
**WBS ID:** `4.5.7`
**Evidence / Source:** `lib/presentation/features/study/screens/study_session_screen.dart`, `lib/presentation/features/study/widgets/study_session_guess_mode_view.dart`, `lib/presentation/features/study/viewmodels/study_session_guess_viewmodel.dart`, `test/presentation/features/study/study_session_screen_test.dart`, `docs/wireframes/15-study-session-guess.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.5.7 | {one-line summary of what was implemented} |
```
