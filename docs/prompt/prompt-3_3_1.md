# Claude Code Task Prompt — WBS 3.3.1: Deck → flashcard list navigation

**Generated:** 2026-06-20
**Flow:** Library | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Deck tile opens `/library/deck/:deckId/flashcards`

## ⚠️ Dependency warnings

⚠️  Dependency `3.2.2` (Folder detail FE) is **Specified** — build it first.
⚠️  Dependency `3.4.2` (Flashcard list FE) is **Specified** — build it first.
...
**WBS ID:** `3.3.1`
**Evidence / Source:** `lib/presentation/features/flashcards/routes/flashcard_routes.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 3.3.1 | {one-line summary of what was implemented} |
```
