# Claude Code Task Prompt — WBS 4.12.1: Study by tag

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Blocked

**Deliverable:**
> `StudyEntryType.tag` scope queries + routes + tests
...
```
| `<8-char-hash>` | 2026-06-19 | 4.12.1 | {one-line summary of what was implemented} |
```
