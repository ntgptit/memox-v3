# Claude Code Task Prompt — WBS 6.2.1: CSV parse BE

**Generated:** 2026-06-20
**Flow:** Import | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Pasted-CSV parse use case + tests

## ⚠️ Dependency warnings

⚠️  Dependency `6.0.1` (**Import type-contract & preview model (ENABLER — B3)**) is **Specified** — build it first.
...
**WBS ID:** `6.2.1`
**Evidence / Source:** `lib/domain/usecases/flashcard/parse_deck_import_csv_usecase.dart`, `test/domain/usecases/flashcard/deck_import_usecases_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 6.2.1 | {one-line summary of what was implemented} |
```
