# Claude Code Task Prompt — WBS 3.5.1: Global search BE

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Search use case + repo, LIKE escaping, ranking, min-query/debounce contract + tests
...
**WBS ID:** `3.5.1`
**Evidence / Source:** `lib/domain/usecases/search/global_search_usecase.dart`, `test/data/repositories/search_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 3.5.1 | {one-line summary of what was implemented} |
```
