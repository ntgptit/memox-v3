# Claude Code Task Prompt — WBS 4.6.1: Finish session BE

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Finalization transaction: attempts → SRS outcome → session complete, rollback on failure
...
**WBS ID:** `4.6.1`
**Evidence / Source:** `lib/data/repositories/study_repo_impl.dart`, `test/data/repositories/study_repository_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 4.6.1 | {one-line summary of what was implemented} |
```
