# Claude Code Task Prompt — WBS 8.1.2: Hide fabricated state before release

**Generated:** 2026-06-20
**Flow:** Settings | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Hide/disable mock account row + mock version on Settings hub. (Dashboard dead `0 days` placeholder resolved by WBS 5.4.2 — replaced with computed streak chip hidden at 0.)

## ⚠️ Dependency warnings

⚠️  Dependency `8.1.1` (Settings hub FE shell) is **Specified** — build it first.
...
**WBS ID:** `8.1.2`
**Evidence / Source:** `docs/wireframes/04-settings-hub.md` + `docs/wireframes/01-dashboard.md`
...
```
| `<8-char-hash>` | 2026-06-20 | 8.1.2 | {one-line summary of what was implemented} |
```
