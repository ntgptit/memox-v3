# Claude Code Task Prompt — WBS 8.6.2: Drive backup/restore BE

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** BE | **Status:** Specified

**Deliverable:**
> AppData-scope upload/restore via platform snapshot gateways

## ⚠️ Dependency warnings

⚠️  Dependency `8.6.1` (Google account linking BE) is **Specified** — build it first.
...
```
| `<8-char-hash>` | 2026-06-19 | 8.6.2 | {one-line summary of what was implemented} |
```
