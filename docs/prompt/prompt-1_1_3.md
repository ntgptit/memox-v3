# Claude Code Task Prompt — WBS 1.1.3: Routing baseline

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> GoRouter shell, `RouteNames`/`RoutePaths` constants, placeholder discipline
...
**WBS ID:** `1.1.3`
**Evidence / Source:** `lib/app/router/app_router.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.1.3 | {one-line summary of what was implemented} |
```
