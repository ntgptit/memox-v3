# Claude Code Task Prompt — WBS 1.2.3: Core widget kit — actions & inputs

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `MxButton`/`MxActionButton`/`MxCardActions`, `MxSearchField`, base input field; goldens + geometry contract
...
**WBS ID:** `1.2.3`
**Evidence / Source:** `lib/presentation/shared/widgets/buttons/**`, `lib/presentation/shared/widgets/inputs/**`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.2.3 | {one-line summary of what was implemented} |
```
