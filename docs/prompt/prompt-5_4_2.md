# Claude Code Task Prompt — WBS 5.4.2: Streak chip + daily-goal ring FE

**Generated:** 2026-06-20
**Flow:** Dashboard | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Streak chip (hidden when `< 1`) + daily-goal ring (hidden when goal disabled) consuming `dashboardProgressSummaryQueryProvider`

## ⚠️ Dependency warnings

⚠️  Dependency `5.4.1` (Progress summary on dashboard) is **Specified** — build it first.
...
**WBS ID:** `5.4.2`
**Evidence / Source:** `lib/presentation/features/dashboard/screens/dashboard_screen.dart` (`_DashboardStatsRow`), `lib/presentation/features/dashboard/viewmodels/dashboard_viewmodel.dart`, `test/presentation/features/dashboard/dashboard_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 5.4.2 | {one-line summary of what was implemented} |
```
