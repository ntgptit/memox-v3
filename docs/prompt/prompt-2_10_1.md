...
**WBS ID:** `2.10.1`
**Evidence / Source:** `lib/domain/usecases/deck/reorder_decks_usecase.dart`, `lib/data/repositories/folder_repo_impl_mutation_helpers.dart`, `lib/data/repositories/folder_repository_impl.dart`, `test/data/repositories/folder_repository_impl_deck_test.dart`, `test/domain/usecases/deck/reorder_decks_usecase_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 2.10.1 | {one-line summary of what was implemented} |
```
