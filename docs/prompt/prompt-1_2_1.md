# Claude Code Task Prompt — WBS 1.2.1: Core widget kit — surfaces & shell

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `MxContentShell`, `MxCard`, `MxListTile`, `MxAvatar` built from shots; golden per state (light+dark)
...
**WBS ID:** `1.2.1`
**Evidence / Source:** `lib/presentation/shared/widgets/surfaces/**`, `lib/presentation/shared/layouts/**`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.2.1 | {one-line summary of what was implemented} |
```
