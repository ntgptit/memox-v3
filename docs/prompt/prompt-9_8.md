# Claude Code Task Prompt — WBS 9.8: Docs-code parity gate

**Generated:** 2026-06-20
**Flow:** Quality | **Layer:** Docs | **Status:** Ongoing

**Deliverable:**
> 8-step pre-commit parity check per `CLAUDE.md`
...
**WBS ID:** `9.8`
**Evidence / Source:** `CLAUDE.md`, `docs/checklist/implementation-checklist.md`
...
```
| `<8-char-hash>` | 2026-06-20 | 9.8 | {one-line summary of what was implemented} |
```
