# Claude Code Task Prompt — WBS 4.2.4: Session batch limit BE V1

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Cap session at `maxSessionItems` (default 20) before persisting session items; backend-only slice
...
**WBS ID:** `4.2.4`
**Evidence / Source:** `docs/business/study/study-flow.md` §Rules, `lib/data/repositories/study_repo_impl.dart`, `test/data/repositories/study_repository_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.2.4 | {one-line summary of what was implemented} |
```
