# Claude Code Task Prompt — WBS 7.4.1: Progress read model BE V1

**Generated:** 2026-06-20
**Flow:** Progress | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Combined progress read model + provider wiring

## ⚠️ Dependency warnings

⚠️  Dependency `7.1.1` (Due summary query BE V1) is **Blocked** — build it first.
⚠️  Dependency `7.2.1` (Box distribution query BE V1) is **Specified** — build it first.
...
```
| `<8-char-hash>` | 2026-06-20 | 7.4.1 | {one-line summary of what was implemented} |
```
