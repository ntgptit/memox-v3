# Claude Code Task Prompt — WBS 3.5.3: Search result navigation

**Generated:** 2026-06-20
**Flow:** Library | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Folder → detail; deck → flashcard list; flashcard → owning deck

## ⚠️ Dependency warnings

⚠️  Dependency `3.5.2` (Global search FE) is **Specified** — build it first.
...
**WBS ID:** `3.5.3`
**Evidence / Source:** `lib/presentation/features/search/widgets/search_results_view.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 3.5.3 | {one-line summary of what was implemented} |
```
