# Claude Code Task Prompt — WBS 10.1: MVP smoke path

**Generated:** 2026-06-19
**Flow:** Release | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Create folder → deck → cards → study → finish → see progress, verified end-to-end

## ⚠️ Dependency warnings

⚠️  Dependency `2.x` not found in WBS — verify ID.
⚠️  Dependency `4.x` not found in WBS — verify ID.
...
**WBS ID:** `10.1`
**Evidence / Source:** study/content flows and progress screen implemented; end-to-end script missing
...
```
| `<8-char-hash>` | 2026-06-19 | 10.1 | {one-line summary of what was implemented} |
```
