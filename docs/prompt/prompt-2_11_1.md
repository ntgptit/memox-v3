# Claude Code Task Prompt — WBS 2.11.1: Flashcard Create BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Front/back required-after-trim validation, optional fields, default SRS progress + tests
...
**WBS ID:** `2.11.1`
**Evidence / Source:** `lib/domain/usecases/flashcard/create_flashcard_usecase.dart`, `test/domain/usecases/flashcard/create_flashcard_usecase_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.11.1 | {one-line summary of what was implemented} |
```
