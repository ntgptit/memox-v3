# Claude Code Task Prompt — WBS 7.5.1: Progress screen FE V1

**Generated:** 2026-06-20
**Flow:** Progress | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `/progress` renders the kit-mock screen: range tabs, cards-studied chart, accuracy + delta + sparkline, box distribution, streak, card states

## ⚠️ Dependency warnings

⚠️  Dependency `7.4.2` (Progress overview read model BE) is **Specified** — build it first.
...
**WBS ID:** `7.5.1`
**Evidence / Source:** `lib/presentation/features/progress/**`, `test/presentation/features/progress/progress_screen_test.dart`, `test/presentation/features/progress/progress_screen_golden_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 7.5.1 | {one-line summary of what was implemented} |
```
