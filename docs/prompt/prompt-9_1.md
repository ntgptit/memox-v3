# Claude Code Task Prompt — WBS 9.1: Route contract gate

**Generated:** 2026-06-19
**Flow:** Quality | **Layer:** Test | **Status:** Ongoing

**Deliverable:**
> No raw route strings; `RouteNames`/`RoutePaths` only; route-order guard
...
**WBS ID:** `9.1`
**Evidence / Source:** router tests under `test/**`
...
```
| `<8-char-hash>` | 2026-06-19 | 9.1 | {one-line summary of what was implemented} |
```
