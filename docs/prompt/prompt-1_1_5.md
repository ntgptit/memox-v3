# Claude Code Task Prompt — WBS 1.1.5: Drift/database baseline

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `.drift` schema layout, `AppDatabase`, migration infrastructure + first table
...
**WBS ID:** `1.1.5`
**Evidence / Source:** `lib/data/datasources/local/app_database.dart`, `lib/data/datasources/local/migrations/**`, `test/data/migrations/**`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.1.5 | {one-line summary of what was implemented} |
```
