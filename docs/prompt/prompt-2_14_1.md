# Claude Code Task Prompt — WBS 2.14.1: Flashcard Reorder BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `sort_order` reorder use case + repo method

## ⚠️ Dependency warnings

⚠️  Dependency `2.11.1` (Flashcard Create BE V1) is **Specified** — build it first.
...
**WBS ID:** `2.14.1`
**Evidence / Source:** `lib/domain/usecases/flashcard/reorder_flashcards_usecase.dart`, `lib/data/repositories/flashcard_repository_impl.dart`, `test/data/repositories/flashcard_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.14.1 | {one-line summary of what was implemented} |
```
