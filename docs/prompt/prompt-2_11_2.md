# Claude Code Task Prompt — WBS 2.11.2: Flashcard Create FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Editor screen (create mode), draft hook, save-and-add-another, states
...
**WBS ID:** `2.11.2`
**Evidence / Source:** `lib/presentation/features/flashcards/screens/flashcard_editor_screen.dart`, `test/presentation/features/flashcards/flashcard_editor_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.11.2 | {one-line summary of what was implemented} |
```
