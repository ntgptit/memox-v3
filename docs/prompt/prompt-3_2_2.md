# Claude Code Task Prompt — WBS 3.2.2: Folder detail FE

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Folder detail screen, tiles, summary, states, navigation
...
**WBS ID:** `3.2.2`
**Evidence / Source:** `lib/presentation/features/folders/screens/folder_detail_screen.dart`, `test/presentation/features/folders/folder_detail_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 3.2.2 | {one-line summary of what was implemented} |
```
