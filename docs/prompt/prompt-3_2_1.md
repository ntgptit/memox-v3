# Claude Code Task Prompt — WBS 3.2.1: Folder detail load BE

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `watchFolderDetail` stream (children, decks, counts) + tests
...
**WBS ID:** `3.2.1`
**Evidence / Source:** `lib/domain/usecases/folder/watch_folder_detail_usecase.dart`, `test/data/repositories/folder_read_queries_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 3.2.1 | {one-line summary of what was implemented} |
```
