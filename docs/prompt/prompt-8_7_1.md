# Claude Code Task Prompt — WBS 8.7.1: Deck export CSV BE V1

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** BE | **Status:** Specified

**Deliverable:**
> CSV export of one deck (escaping, file name sanitizing) + tests
...
```
| `<8-char-hash>` | 2026-06-19 | 8.7.1 | {one-line summary of what was implemented} |
```
