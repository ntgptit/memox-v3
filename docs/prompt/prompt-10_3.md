# Claude Code Task Prompt — WBS 10.3: Web readiness

**Generated:** 2026-06-19
**Flow:** Release | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Wasm/worker DB connection verified on web

## ⚠️ Dependency warnings

⚠️  Dependency `10.1` (MVP smoke path) is **Specified** — build it first.
...
**WBS ID:** `10.3`
**Evidence / Source:** `lib/data/datasources/local/connection/database_connection_web.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 10.3 | {one-line summary of what was implemented} |
```
