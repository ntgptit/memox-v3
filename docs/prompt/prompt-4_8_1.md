# Claude Code Task Prompt — WBS 4.8.1: Session persistence recovery

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> In-progress sessions reload by sessionId preserving answered items
...
**WBS ID:** `4.8.1`
**Evidence / Source:** `test/presentation/features/study/study_session_screen_test.dart` (recovery coverage)
...
```
| `<8-char-hash>` | 2026-06-19 | 4.8.1 | {one-line summary of what was implemented} |
```
