# Claude Code Task Prompt — WBS 5.5.1: Dashboard data refresh

**Generated:** 2026-06-19
**Flow:** Dashboard | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Refresh on retry and on return from study flow

## ⚠️ Dependency warnings

⚠️  Dependency `5.1.2` (Continue Studying card FE) is **Specified** — build it first.
...
### Task-specific
- `docs/contracts/usecase-contracts/engagement.md`
...
**WBS ID:** `5.5.1`
**Evidence / Source:** `lib/presentation/features/dashboard/viewmodels/dashboard_viewmodel.dart` (invalidate on retry)
...
```
| `<8-char-hash>` | 2026-06-19 | 5.5.1 | {one-line summary of what was implemented} |
```
