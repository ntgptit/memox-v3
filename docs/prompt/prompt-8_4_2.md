# Claude Code Task Prompt — WBS 8.4.2: Audio/speech settings FE wiring

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Wire `/settings/audio-speech` shell to real TTS settings
...
- `docs/wireframes/21-settings-audio-speech.md`
...
**WBS ID:** `8.4.2`
**Evidence / Source:** `lib/presentation/features/settings/screens/audio_speech_settings_screen.dart` (static mock preview); `lib/presentation/features/settings/providers/tts_settings_notifier.dart` (provider ready)
...
```
| `<8-char-hash>` | 2026-06-19 | 8.4.2 | {one-line summary of what was implemented} |
```
