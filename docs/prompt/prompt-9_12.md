# Claude Code Task Prompt — WBS 9.12: doc_guard baseline burn-down

**Generated:** 2026-06-20
**Flow:** Quality | **Layer:** Docs | **Status:** Specified

**Deliverable:**
> Reduce `tool/doc_guard/baseline.json` (57 findings: decision-table phantom test refs, wireframe target-widget refs, contract stale paths) to zero
...
**WBS ID:** `9.12`
**Evidence / Source:** `tool/doc_guard/baseline.json`
...
```
| `<8-char-hash>` | 2026-06-20 | 9.12 | {one-line summary of what was implemented} |
```
