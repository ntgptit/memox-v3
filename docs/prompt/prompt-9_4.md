# Claude Code Task Prompt — WBS 9.4: Transaction safety gate

**Generated:** 2026-06-20
**Flow:** Quality | **Layer:** Test | **Status:** Ongoing

**Deliverable:**
> Multi-table writes always transactional (import, session, finalize, future bulk/tags)
...
**WBS ID:** `9.4`
**Evidence / Source:** `test/data/repositories/study_repository_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 9.4 | {one-line summary of what was implemented} |
```
