# Claude Code Task Prompt — WBS 9.14: Golden-diff visual parity runner

**Generated:** 2026-06-19
**Flow:** Quality | **Layer:** Test | **Status:** Specified

**Deliverable:**
> `python tool/golden_diff/diff.py`: pixel-diff Flutter golden vs mock shot, mismatch % + diff region; text feedback loop for no-vision agents
...
**WBS ID:** `9.14`
**Evidence / Source:** `tool/golden_diff/diff.py` (runner only; the per-screen golden-test gate remains Specified)
...
```
| `<8-char-hash>` | 2026-06-19 | 9.14 | {one-line summary of what was implemented} |
```
