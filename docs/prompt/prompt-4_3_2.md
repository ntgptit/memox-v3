# Claude Code Task Prompt — WBS 4.3.2: Session review shell FE

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Current card, reveal toggle, Previous/Next navigation
...
**WBS ID:** `4.3.2`
**Evidence / Source:** `lib/presentation/features/study/screens/study_session_screen.dart`, `test/presentation/features/study/study_session_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 4.3.2 | {one-line summary of what was implemented} |
```
