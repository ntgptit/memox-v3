# Claude Code Task Prompt — WBS 1.2.4: Core widget kit — state widgets

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `MxLoadingState`, `MxEmptyState`, `MxErrorState`, `MxNoResultsState`; goldens; semantics
...
**WBS ID:** `1.2.4`
**Evidence / Source:** `lib/presentation/shared/widgets/states/**`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.2.4 | {one-line summary of what was implemented} |
```
