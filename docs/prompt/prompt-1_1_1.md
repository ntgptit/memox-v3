# Claude Code Task Prompt — WBS 1.1.1: Architecture baseline

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Clean Architecture skeleton (`app`/`core`/`domain`/`data`/`presentation`) with DI providers
...
```
| `<8-char-hash>` | 2026-06-19 | 1.1.1 | {one-line summary of what was implemented} |
```
