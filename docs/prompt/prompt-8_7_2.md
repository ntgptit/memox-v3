# Claude Code Task Prompt — WBS 8.7.2: Deck export FE V1

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Export action on deck actions sheet → share/save (`share_plus`, needs dependency approval)

## ⚠️ Dependency warnings

⚠️  Dependency `8.7.1` (Deck export CSV BE V1) is **Specified** — build it first.
...
**WBS ID:** `8.7.2`
**Evidence / Source:** `docs/business/export/export.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 8.7.2 | {one-line summary of what was implemented} |
```
