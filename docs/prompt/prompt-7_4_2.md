# Claude Code Task Prompt — WBS 7.4.2: Progress overview read model BE

**Generated:** 2026-06-19
**Flow:** Progress | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Range activity (per-local-day buckets + previous-range delta), study-day streak, suspended/buried counts composed into `ProgressOverview` + tests

## ⚠️ Dependency warnings

⚠️  Dependency `7.4.1` (Progress read model BE V1) is **Specified** — build it first.
...
**WBS ID:** `7.4.2`
**Evidence / Source:** `lib/domain/models/progress_read_model.dart`, `lib/domain/types/progress_range.dart`, `lib/domain/usecases/progress/load_progress_overview_usecase.dart`, `lib/data/repositories/progress_repository_impl.dart`, `test/data/repositories/progress_repository_overview_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 7.4.2 | {one-line summary of what was implemented} |
```
