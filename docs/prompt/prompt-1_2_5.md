# Claude Code Task Prompt — WBS 1.2.5: Core widget kit — dialogs & sheets

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `MxDialog`, `MxConfirmDialog`, `MxBottomSheet` shells with content slot; goldens

## ⚠️ Dependency warnings

⚠️  Dependency `1.2.1` (Core widget kit — surfaces & shell) is **Specified** — build it first.
...
**WBS ID:** `1.2.5`
**Evidence / Source:** `lib/presentation/shared/dialogs/**`, `docs/wireframes/24-shared-dialogs.md`, `docs/wireframes/25-shared-bottom-sheets.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.2.5 | {one-line summary of what was implemented} |
```
