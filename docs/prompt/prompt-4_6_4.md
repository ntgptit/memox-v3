# Claude Code Task Prompt — WBS 4.6.4: Due-time local-midnight normalization

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `due_at = localMidnight(studyDay + interval)` so due-today counts are stable across the day

## ⚠️ Dependency warnings

⚠️  Dependency `4.6.2` (SRS progress update BE) is **Specified** — build it first.
...
**WBS ID:** `4.6.4`
**Evidence / Source:** `docs/business/srs/srs-review.md` §Interval table, `lib/data/repositories/study_repo_impl.dart`, `test/data/repositories/study_srs_transition_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 4.6.4 | {one-line summary of what was implemented} |
```
