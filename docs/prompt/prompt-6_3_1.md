# Claude Code Task Prompt — WBS 6.3.1: Preview FE (valid/invalid rows)

**Generated:** 2026-06-19
**Flow:** Import | **Layer:** FE | **Status:** Specified

**Deliverable:**
> In-screen preview: rows + issues + summary; clean preview enables CTA
...
```
| `<8-char-hash>` | 2026-06-19 | 6.3.1 | {one-line summary of what was implemented} |
```
