# Claude Code Task Prompt — WBS 3.5.2: Global search FE

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** FE | **Status:** Specified

**Deliverable:**
> `/library/search` screen with 5 states, grouped sections

## ⚠️ Dependency warnings

⚠️  Dependency `3.5.1` (Global search BE) is **Specified** — build it first.
...
**WBS ID:** `3.5.2`
**Evidence / Source:** `lib/presentation/features/search/screens/global_search_screen.dart`, `test/presentation/features/search/global_search_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 3.5.2 | {one-line summary of what was implemented} |
```
