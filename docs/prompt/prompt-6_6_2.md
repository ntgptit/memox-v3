# Claude Code Task Prompt — WBS 6.6.2: Duplicate preview FE V1

**Generated:** 2026-06-20
**Flow:** Import | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Duplicate rows surfaced in preview with skip policy

## ⚠️ Dependency warnings

⚠️  Dependency `6.6.1` (Duplicate detection BE V1) is **Specified** — build it first.
...
**WBS ID:** `6.6.2`
**Evidence / Source:** `docs/wireframes/10-deck-import.md`
...
```
| `<8-char-hash>` | 2026-06-20 | 6.6.2 | {one-line summary of what was implemented} |
```
