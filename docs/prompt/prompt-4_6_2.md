# Claude Code Task Prompt — WBS 4.6.2: SRS progress update BE

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Leitner outcome transitions + due-date computation in finalization

## ⚠️ Dependency warnings

⚠️  Dependency `4.6.1` (Finish session BE) is **Specified** — build it first.
...
**WBS ID:** `4.6.2`
**Evidence / Source:** `lib/data/repositories/study_repo_impl_study_session.dart`, `test/data/repositories/study_srs_transition_test.dart` (verified equal to `docs/business/srs/srs-review.md` transition + interval tables, decision rows S11–S15)
...
```
| `<8-char-hash>` | 2026-06-20 | 4.6.2 | {one-line summary of what was implemented} |
```
