# Claude Code Task Prompt — WBS 6.9.1: Structured text import BE

**Generated:** 2026-06-20
**Flow:** Import | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Separator auto/tab/comma/colon/slash/semicolon/pipe

## ⚠️ Dependency warnings

⚠️  Dependency `6.2.1` (CSV parse BE) is **Specified** — build it first.
...
**WBS ID:** `6.9.1`
**Evidence / Source:** `lib/domain/usecases/flashcard/prepare_deck_import_usecase.dart`, `lib/domain/usecases/flashcard/parse_deck_import_csv_usecase.dart`, `lib/domain/models/flashcard_import_preview.dart`, `test/domain/usecases/flashcard/deck_import_usecases_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 6.9.1 | {one-line summary of what was implemented} |
```
