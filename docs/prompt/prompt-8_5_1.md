# Claude Code Task Prompt — WBS 8.5.1: Account settings screen V1

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Replace `/settings/account` placeholder with linked/unlinked display

## ⚠️ Dependency warnings

⚠️  Dependency `1.1.3` (Routing baseline) is **Specified** — build it first.
...
- `docs/wireframes/19-settings-account.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 8.5.1 | {one-line summary of what was implemented} |
```
