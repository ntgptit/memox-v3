# Claude Code Task Prompt — WBS 2.20.1: Manual duplicate soft-warning BE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Case-insensitive front+back duplicate check on create/edit save
...
```
| `<8-char-hash>` | 2026-06-19 | 2.20.1 | {one-line summary of what was implemented} |
```
