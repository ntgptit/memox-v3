# Claude Code Task Prompt — WBS 9.11: doc_guard docs/process gate

**Generated:** 2026-06-19
**Flow:** Quality | **Layer:** Test | **Status:** Specified

**Deliverable:**
> `node tool/doc_guard/run.mjs check`: doc path/symbol/test-ref existence, WBS hygiene (columns, status vocab, commit hashes), ARB duplicate/missing keys, schema version drift; baseline mechanism for pre-existing findings
...
**WBS ID:** `9.11`
**Evidence / Source:** `tool/doc_guard/run.mjs`, `tool/doc_guard/baseline.json`, `CLAUDE.md` §Verification commands
...
```
| `<8-char-hash>` | 2026-06-19 | 9.11 | {one-line summary of what was implemented} |
```
