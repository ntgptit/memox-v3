# Claude Code Task Prompt — WBS 9.6: l10n coverage gate

**Generated:** 2026-06-19
**Flow:** Quality | **Layer:** Test | **Status:** Ongoing

**Deliverable:**
> No hardcoded user-facing strings; ARB keys per copy change

## ⚠️ Dependency warnings

⚠️  Dependency `1.1.4` (l10n baseline) is **Specified** — build it first.
...
**WBS ID:** `9.6`
**Evidence / Source:** `lib/l10n/app_en.arb`, `lib/l10n/app_vi.arb`
...
```
| `<8-char-hash>` | 2026-06-19 | 9.6 | {one-line summary of what was implemented} |
```
