# Claude Code Task Prompt — WBS 8.6.1: Google account linking BE

**Generated:** 2026-06-20
**Flow:** Settings | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Optional sign-in, account statuses, SharedPreferences link store

## ⚠️ Dependency warnings

⚠️  Dependency `8.5.1` (Account settings screen V1) is **Specified** — build it first.
...
### Task-specific
- `docs/contracts/usecase-contracts/account-sync.md`
...
**WBS ID:** `8.6.1`
**Evidence / Source:** `docs/business/account-sync/account-sync.md`
...
```
| `<8-char-hash>` | 2026-06-20 | 8.6.1 | {one-line summary of what was implemented} |
```
