# Claude Code Task Prompt — WBS 4.2.3: Resume/start-over choice FE

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Explicit Resume / Start over / Back actions; transactional restart

## ⚠️ Dependency warnings

⚠️  Dependency `4.2.2` (No-silent-resume gate BE) is **Specified** — build it first.
...
**WBS ID:** `4.2.3`
**Evidence / Source:** `lib/presentation/features/study/widgets/study_entry_resume_required_state.dart`, `test/domain/study/restart_study_session_usecase_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.2.3 | {one-line summary of what was implemented} |
```
