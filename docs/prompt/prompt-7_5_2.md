# Claude Code Task Prompt — WBS 7.5.2: Progress states FE

**Generated:** 2026-06-19
**Flow:** Progress | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Loading/empty/error/insufficient/partial states per kit mock, data-driven per section
...
**WBS ID:** `7.5.2`
**Evidence / Source:** `test/presentation/features/progress/progress_screen_test.dart` (states), goldens for 7 states × light/dark
...
```
| `<8-char-hash>` | 2026-06-19 | 7.5.2 | {one-line summary of what was implemented} |
```
