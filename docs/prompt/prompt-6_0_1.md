# Claude Code Task Prompt — WBS 6.0.1: **Import type-contract & preview model (ENABLER — B3)**

**Generated:** 2026-06-20
**Flow:** Import | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Pin `FlashcardImportPreview`, row-issue enum, `ImportSourceFormat` value objects + repo/use-case signatures in domain + `docs/contracts/types-catalog.md`; no parsing logic yet (lands in 6.2.x)
...
**WBS ID:** `6.0.1`
**Evidence / Source:** `lib/domain/models/flashcard_import_preview.dart`, `lib/domain/types/**`, `docs/contracts/types-catalog.md`, `docs/business/flashcard/flashcard-management.md` (import section)
...
```
| `<8-char-hash>` | 2026-06-20 | 6.0.1 | {one-line summary of what was implemented} |
```
