# Claude Code Task Prompt — WBS 5.2.2: Today study CTA FE

**Generated:** 2026-06-19
**Flow:** Dashboard | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Today's-review card: due count title + due-deck count + estimated minutes; `dueToday > 0` routes to today study, zero state disables CTA
...
**WBS ID:** `5.2.2`
**Evidence / Source:** `lib/presentation/features/dashboard/screens/dashboard_screen.dart` (`_DashboardTodayCard`, `dashboardDueSummaryQueryProvider`), `test/presentation/features/dashboard/dashboard_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 5.2.2 | {one-line summary of what was implemented} |
```
