# Claude Code Task Prompt — WBS 2.3.2: Folder Delete FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Confirmation dialog + success/error state

## ⚠️ Dependency warnings

⚠️  Dependency `2.3.1` (Folder Delete BE V1) is **Specified** — build it first.
...
**WBS ID:** `2.3.2`
**Evidence / Source:** `lib/presentation/shared/dialogs/mx_folder_delete_dialog.dart`, `test/presentation/shared/dialogs/mx_folder_delete_dialog_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.3.2 | {one-line summary of what was implemented} |
```
