# Claude Code Task Prompt — WBS 4.11.3: In-session bury/suspend action FE

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Action UI, queue removal, undo affordance

## ⚠️ Dependency warnings

⚠️  Dependency `4.11.2` (In-session bury/suspend action BE) is **Specified** — build it first.
...
**WBS ID:** `4.11.3`
**Evidence / Source:** `docs/business/study-actions/bury-suspend.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.11.3 | {one-line summary of what was implemented} |
```
