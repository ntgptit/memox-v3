# Claude Code Task Prompt — WBS 3.4.1: Flashcard list load BE

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `watchFlashcardList` stream + tests
...
**WBS ID:** `3.4.1`
**Evidence / Source:** `lib/domain/usecases/flashcard/watch_flashcard_list_usecase.dart`, `test/data/repositories/flashcard_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 3.4.1 | {one-line summary of what was implemented} |
```
