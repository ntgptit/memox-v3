# Claude Code Task Prompt — WBS 1.1.2: Theme tokens + design-system baseline

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Theme tokens (colors/type/spacing/radius), `MxTheme`, dark/light schemes from the design system
...
**WBS ID:** `1.1.2`
**Evidence / Source:** `lib/core/theme/**`
...
```
| `<8-char-hash>` | 2026-06-19 | 1.1.2 | {one-line summary of what was implemented} |
```
