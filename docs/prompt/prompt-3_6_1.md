# Claude Code Task Prompt — WBS 3.6.1: Error retry state

**Generated:** 2026-06-20
**Flow:** Library | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Centralized failure mapping + refetch feedback on library screens

## ⚠️ Dependency warnings

⚠️  Dependency `3.1.2` (Library overview FE) is **Specified** — build it first.
...
**WBS ID:** `3.6.1`
**Evidence / Source:** `lib/app/feedback/**`, `test/app/feedback/mx_app_feedback_observer_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 3.6.1 | {one-line summary of what was implemented} |
```
