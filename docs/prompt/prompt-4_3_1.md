# Claude Code Task Prompt — WBS 4.3.1: Session item loading BE

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Load persisted session + ordered items by sessionId
...
**WBS ID:** `4.3.1`
**Evidence / Source:** `lib/domain/study/ports/study_repo.dart` (`loadStudySessionReview`)
...
```
| `<8-char-hash>` | 2026-06-19 | 4.3.1 | {one-line summary of what was implemented} |
```
