# Claude Code Task Prompt — WBS 5.8.1: App-bar search shortcut FE

**Generated:** 2026-06-19
**Flow:** Dashboard | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Dashboard search icon → `/library/search` (`pushLibrarySearch`)
...
**WBS ID:** `5.8.1`
**Evidence / Source:** `lib/presentation/features/dashboard/screens/dashboard_screen.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 5.8.1 | {one-line summary of what was implemented} |
```
