# Claude Code Task Prompt — WBS 2.13.2: Flashcard Delete FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Row actions sheet delete + confirmation + states
...
**WBS ID:** `2.13.2`
**Evidence / Source:** `lib/presentation/features/flashcards/widgets/flashcard_row_actions_sheet.dart`, `test/presentation/features/flashcards/flashcard_list_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 2.13.2 | {one-line summary of what was implemented} |
```
