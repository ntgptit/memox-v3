# Claude Code Task Prompt — WBS 7.6.2: Card history use cases

**Generated:** 2026-06-19
**Flow:** Progress | **Layer:** Domain | **Status:** Specified

**Deliverable:**
> `GetCardHistoryHeaderUseCase`, `GetCardHistoryPageUseCase`, `ResetFlashcardProgressUseCase` + DI

## ⚠️ Dependency warnings

⚠️  Dependency `7.6.1` (Review history query BE) is **Specified** — build it first.
...
**WBS ID:** `7.6.2`
**Evidence / Source:** `lib/domain/usecases/history/**`, `lib/domain/models/card_history.dart`, `lib/app/di/card_history_providers.dart`, `test/data/repositories/card_history_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 7.6.2 | {one-line summary of what was implemented} |
```
