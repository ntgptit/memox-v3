# Claude Code Task Prompt — WBS 4.4.3: Answer re-grade before finalize

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Allow correcting an answered item's grade until finalization (append attempt)
...
**WBS ID:** `4.4.3`
**Evidence / Source:** `docs/business/study/study-flow.md` §Retry behavior
...
```
| `<8-char-hash>` | 2026-06-19 | 4.4.3 | {one-line summary of what was implemented} |
```
