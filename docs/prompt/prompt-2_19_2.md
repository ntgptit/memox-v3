# Claude Code Task Prompt — WBS 2.19.2: Deck Move FE V1

**Generated:** 2026-06-20
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Move action in deck actions sheet + folder picker

## ⚠️ Dependency warnings

⚠️  Dependency `2.19.1` (Deck Move BE V1) is **Implemented (2026-06-20)** — build it first.
...
**WBS ID:** `2.19.2`
**Evidence / Source:** `lib/presentation/features/folders/widgets/folder_move_picker_sheet.dart` (reuse picker pattern)
...
```
| `<8-char-hash>` | 2026-06-20 | 2.19.2 | {one-line summary of what was implemented} |
```
