# Claude Code Task Prompt — WBS 1.1.4: l10n baseline

**Generated:** 2026-06-19
**Flow:** Foundation | **Layer:** FE | **Status:** Specified

**Deliverable:**
> ARB en/vi + generated localizations pipeline
...
```
| `<8-char-hash>` | 2026-06-19 | 1.1.4 | {one-line summary of what was implemented} |
```
