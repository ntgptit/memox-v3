# Claude Code Task Prompt — WBS 3.2.3: Folder detail new vs due study split

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** BE+FE | **Status:** Specified

**Deliverable:**
> New cards (`due_at NULL`) counted as NEW not due (data fix + migration v11); `new_count` read model on deck/subfolder rows; folder summary shows `{n} new`/`{m} due` + **Study new** (→ `study_type=new`) and **Review due** (→ `srs_review`) CTAs; deck-row new badge

## ⚠️ Dependency warnings

⚠️  Dependency `3.2.2` (Folder detail FE) is **Specified** — build it first.
⚠️  Dependency `4.5.10` (Daily new limit BE V1) is **Specified** — build it first.
...
```
| `<8-char-hash>` | 2026-06-19 | 3.2.3 | {one-line summary of what was implemented} |
```
