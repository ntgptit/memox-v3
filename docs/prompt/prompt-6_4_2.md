# Claude Code Task Prompt — WBS 6.4.2: No silent partial import

**Generated:** 2026-06-20
**Flow:** Import | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Commit only proceeds on clean preview; all-or-nothing insert

## ⚠️ Dependency warnings

⚠️  Dependency `6.4.1` (Transactional commit BE) is **Specified** — build it first.
...
**WBS ID:** `6.4.2`
**Evidence / Source:** `test/presentation/features/flashcards/deck_import_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 6.4.2 | {one-line summary of what was implemented} |
```
