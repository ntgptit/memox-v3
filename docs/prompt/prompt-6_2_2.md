# Claude Code Task Prompt — WBS 6.2.2: Row validation BE

**Generated:** 2026-06-20
**Flow:** Import | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Per-row validation issues in preview model
...
**WBS ID:** `6.2.2`
**Evidence / Source:** `lib/domain/models/flashcard_import_preview.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 6.2.2 | {one-line summary of what was implemented} |
```
