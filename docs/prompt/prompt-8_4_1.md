# Claude Code Task Prompt — WBS 8.4.1: TTS service BE

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `TtsService` abstraction + platform implementation + settings storage + tests
...
### Task-specific
- `docs/contracts/usecase-contracts/tts.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 8.4.1 | {one-line summary of what was implemented} |
```
