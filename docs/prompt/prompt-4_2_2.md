# Claude Code Task Prompt — WBS 4.2.2: No-silent-resume gate BE

**Generated:** 2026-06-20
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Existing resumable session returns controlled `resumeRequired`
...
**WBS ID:** `4.2.2`
**Evidence / Source:** `lib/domain/study/study_entry_start_result.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 4.2.2 | {one-line summary of what was implemented} |
```
