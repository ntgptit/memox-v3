# Claude Code Task Prompt — WBS 5.4.1: Progress summary on dashboard

**Generated:** 2026-06-20
**Flow:** Dashboard | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Dashboard progress summary read model + provider wiring (due today, goal, streak)
...
```
| `<8-char-hash>` | 2026-06-20 | 5.4.1 | {one-line summary of what was implemented} |
```
