# Claude Code Task Prompt — WBS 9.13: Repo-map cold-start snapshot

**Generated:** 2026-06-20
**Flow:** Quality | **Layer:** Docs | **Status:** Specified

**Deliverable:**
> `docs/_generated/repo-map.md` generated summary (schema, routes+placeholders, use cases, screens, tests) for agent session bootstrap
...
**WBS ID:** `9.13`
**Evidence / Source:** `docs/_generated/repo-map.md`, `tool/doc_guard/run.mjs` (`generate`)
...
```
| `<8-char-hash>` | 2026-06-20 | 9.13 | {one-line summary of what was implemented} |
```
