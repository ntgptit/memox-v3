# Claude Code Task Prompt — WBS 4.6.3: Finalization failure recovery

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** Integration | **Status:** Specified

**Deliverable:**
> Finish failure keeps session open with controlled error; retry affordance
...
**WBS ID:** `4.6.3`
**Evidence / Source:** `test/data/repositories/study_repository_test.dart` (rollback)
...
```
| `<8-char-hash>` | 2026-06-19 | 4.6.3 | {one-line summary of what was implemented} |
```
