# Claude Code Task Prompt — WBS 2.17.2: Flashcard status filter/badges FE V1

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Filter chips + suspended/buried badges in flashcard list

## ⚠️ Dependency warnings

⚠️  Dependency `2.17.1` (Flashcard status filter BE V1) is **Specified** — build it first.
...
```
| `<8-char-hash>` | 2026-06-19 | 2.17.2 | {one-line summary of what was implemented} |
```
