# Claude Code Task Prompt — WBS 3.1.1: Library overview load BE

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** BE | **Status:** Specified

**Deliverable:**
> `watchLibraryOverview` stream query, stable ordering + tests
...
**WBS ID:** `3.1.1`
**Evidence / Source:** `lib/domain/usecases/folder/watch_library_overview_usecase.dart`, `test/data/repositories/folder_read_queries_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 3.1.1 | {one-line summary of what was implemented} |
```
