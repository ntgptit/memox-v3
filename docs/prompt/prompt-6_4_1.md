# Claude Code Task Prompt — WBS 6.4.1: Transactional commit BE

**Generated:** 2026-06-19
**Flow:** Import | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Insert valid rows + default SRS progress in one transaction; rollback tests

## ⚠️ Dependency warnings

⚠️  Dependency `6.2.2` (Row validation BE) is **Specified** — build it first.
...
**WBS ID:** `6.4.1`
**Evidence / Source:** `lib/domain/usecases/flashcard/commit_deck_import_usecase.dart`, `test/presentation/features/flashcards/deck_import_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 6.4.1 | {one-line summary of what was implemented} |
```
