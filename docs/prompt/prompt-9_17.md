# Claude Code Task Prompt — WBS 9.17: Pre-commit hook + repo hygiene

**Generated:** 2026-06-19
**Flow:** Quality | **Layer:** Test | **Status:** Specified

**Deliverable:**
> `.githooks/pre-commit` runs doc_guard + whitespace check on every commit (opt-in `git config core.hooksPath .githooks`, activated in this clone); `.gitattributes` normalizes line endings ending the CRLF warning flood
...
**WBS ID:** `9.17`
**Evidence / Source:** `.githooks/pre-commit`, `.gitattributes`; live-tested on the landing commit
...
```
| `<8-char-hash>` | 2026-06-19 | 9.17 | {one-line summary of what was implemented} |
```
