# Claude Code Task Prompt — WBS 2.16.1: Parent-child validation BE

**Generated:** 2026-06-19
**Flow:** Content management | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Deck must belong to folder; flashcard must belong to deck (non-null FK + repo checks)
...
**WBS ID:** `2.16.1`
**Evidence / Source:** `lib/data/datasources/local/drift/**` (non-null `folder_id`/`deck_id`)
...
```
| `<8-char-hash>` | 2026-06-19 | 2.16.1 | {one-line summary of what was implemented} |
```
