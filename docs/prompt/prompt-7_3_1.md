# Claude Code Task Prompt — WBS 7.3.1: Study statistics BE V1

**Generated:** 2026-06-19
**Flow:** Progress | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Session/attempt-based stats (sessions finished, answers recorded) + tests
...
**WBS ID:** `7.3.1`
**Evidence / Source:** `lib/data/datasources/local/drift/progress_queries.drift`, `lib/data/datasources/local/daos/progress_dao.dart`, `lib/data/repositories/progress_repository_impl.dart`, `test/data/repositories/progress_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 7.3.1 | {one-line summary of what was implemented} |
```
