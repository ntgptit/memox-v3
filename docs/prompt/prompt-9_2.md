# Claude Code Task Prompt — WBS 9.2: Riverpod usage gate

**Generated:** 2026-06-20
**Flow:** Quality | **Layer:** Test | **Status:** Ongoing

**Deliverable:**
> No `ref.watch` in callbacks; watch/read/listen per state contract
...
**WBS ID:** `9.2`
**Evidence / Source:** `docs/state/state-management-contract.md`
...
```
| `<8-char-hash>` | 2026-06-20 | 9.2 | {one-line summary of what was implemented} |
```
