# Claude Code Task Prompt — WBS 3.7.1: Folder/deck due+card counts BE

**Generated:** 2026-06-19
**Flow:** Library | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Counts stream from DB; due excludes buried/suspended

## ⚠️ Dependency warnings

⚠️  Dependency `3.2.1` (Folder detail load BE) is **Specified** — build it first.
...
**WBS ID:** `3.7.1`
**Evidence / Source:** `lib/data/datasources/local/drift/folder_queries.drift`, `lib/data/repositories/folder_repository_impl.dart`, `test/data/repositories/folder_deck_due_counts_test.dart`, `test/data/repositories/folder_repository_impl_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 3.7.1 | {one-line summary of what was implemented} |
```
