# Claude Code Task Prompt — WBS 8.9.2: Bulk selection mode FE

**Generated:** 2026-06-19
**Flow:** Settings | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Long-press selection mode in flashcard list

## ⚠️ Dependency warnings

⚠️  Dependency `8.9.1` (Bulk operations V1) is **Specified** — build it first.
...
**WBS ID:** `8.9.2`
**Evidence / Source:** `docs/business/bulk/bulk-operations.md`
...
```
| `<8-char-hash>` | 2026-06-19 | 8.9.2 | {one-line summary of what was implemented} |
```
