# Claude Code Task Prompt — WBS 5.3.1: New-user empty dashboard FE

**Generated:** 2026-06-20
**Flow:** Dashboard | **Layer:** FE | **Status:** Specified

**Deliverable:**
> Controlled empty/caught-up states

## ⚠️ Dependency warnings

⚠️  Dependency `5.2.2` (Today study CTA FE) is **Specified** — build it first.
...
**WBS ID:** `5.3.1`
**Evidence / Source:** `test/presentation/features/dashboard/dashboard_screen_test.dart`
...
```
| `<8-char-hash>` | 2026-06-20 | 5.3.1 | {one-line summary of what was implemented} |
```
