# Claude Code Task Prompt — WBS 4.1.1: Study entry eligibility BE

**Generated:** 2026-06-19
**Flow:** Study/SRS | **Layer:** BE | **Status:** Specified

**Deliverable:**
> Scope queries (deck/folder/today), empty/all-suspended outcomes + tests
...
**WBS ID:** `4.1.1`
**Evidence / Source:** `lib/data/repositories/study_repo_impl_study_session.dart`, `test/domain/study/start_study_session_usecase_test.dart`
...
```
| `<8-char-hash>` | 2026-06-19 | 4.1.1 | {one-line summary of what was implemented} |
```
