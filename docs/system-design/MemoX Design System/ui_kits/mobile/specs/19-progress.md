    ...
    - node: div
      ...
      - node: button
        ...
        box:
          ...
          rel: [3,3 65x32]
        spacing: pad:0/16
        style: bg:on-primary font:12/600 color:font-headline text:center r:9 shadow:1/2
      - node: button
        text: Month
        mx: ?
        box:
          ...
          rel: [70,3 69x32]
        spacing: pad:0/16
        style: font:12/600 color:on-surface-variant text:center r:9
      - node: button
        text: All time
        mx: ?
        box:
      ...
      - node: div
        ...
        - node: div
          ...
          - node: div
            ...
            style: font:24/700/26 color:font-headline tracking:-0.5
          - node: div
        ...
        - node: div
          ...
          - node: div
            box:
              abs: [38,283 40x43]
              rel: [0,35 40x43]
            style: bg:color(srgb 0.321569 0.396078 0.960784 / 0.55) r:4
        - node: div
          box:
            abs: [86,247 40x78]
            rel: [50,0 40x78]
        ...
        - node: div
          ...
          - node: div
            box:
              abs: [135,323 40x2]
              rel: [0,76 40x2]
            style: bg:surface-container-high r:4
        - node: div
          box:
            abs: [183,247 40x78]
            rel: [147,0 40x78]
        ...
        - node: div
          ...
          - node: span
            ...
            box:
              abs: [36,654 18x15]
              rel: [0,0 18x15]
            style: font:12/700 color:on-surface-variant text:right
          - node: div
            box:
              abs: [62,655 268x14]
              rel: [26,1 268x14]
            position: pos:relative clip
            style: bg:surface-container r:5
            - node: div
              box:
                abs: [62,655 75x14]
                rel: [0,0 75x14]
              style: bg:seed-indigo op:0.43125
          - node: span
            text: 24
            box:
              abs: [338,654 32x15]
              rel: [302,0 32x15]
            style: font:12/700 color:font-headline text:right
        - node: div
          item: item[2]
          box:
            abs: [36,676 334x15]
          ...
          - node: div
            ...
            - node: div
              box:
                abs: [62,677 118x14]
                rel: [0,0 118x14]
              style: bg:seed-indigo op:0.5125
          - node: span
            text: 38
            box:
              abs: [338,676 32x15]
          ...
          - node: div
            ...
            - node: div
              box:
                abs: [62,699 168x14]
                rel: [0,0 168x14]
              style: bg:seed-indigo op:0.59375
          - node: span
            text: 54
            box:
              abs: [338,698 32x15]
          ...
          - node: div
            ...
            - node: div
              box:
                abs: [62,743 268x14]
                rel: [0,0 268x14]
              style: bg:seed-indigo op:0.75625
          - node: span
            text: 86
            box:
              abs: [338,742 32x15]
      ...
      - node: div
        ...
        - node: div
          box:
            ...
            rel: [14,23 30x30]
          layout: flex:row justify:center align:center
          style: bg:surface-container r:9
          - node: span
            box:
              abs: [44,1053 14x14]
              rel: [8,8 14x14]
        ...
        - node: div
          ...
          - node: div
            ...
            box:
              abs: [269,1042 74x21]
              rel: [0,0 74x21]
            style: font:16/700 color:font-headline text:right
          - node: div
            ...
            box:
              ...
              rel: [0,22 74x15]
            spacing: margin:1/0/0/0
            style: font:12/400 color:on-surface-variant text:right
        - node: span
          box:
            abs: [355,1053 15x15]
            rel: [333,31 15x15]
    ...
    - node: card
      ...
      - node: span
        box:
          abs: [36,225 334x70]
          rel: [14,65 334x70]
        style: bg:surface-container-high r:10 op:0.5
    - node: card
      mx: MxCard
      box:
        abs: [22,321 362x149]
...
+ rel: [14,39 334x86]
+ spacing: pad:24/16
+ style: bg:on-primary font:12/400/18 color:on-surface-variant text:center r:12 border:1px outline-variant
  - node: card
  mx: MxCard
  box:
  abs: [22,311 362x121]
