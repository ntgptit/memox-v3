...
///
/// The session route renders the real `StudySessionScreen`; only the result
/// route remains a placeholder. Today and scoped study entry are real screens
/// that start persisted sessions when eligible cards exist.
