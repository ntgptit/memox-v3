...
class TtsSettingsNotifier extends _$TtsSettingsNotifier {
  ...
  Future<void> updateVoice(String? voiceName) =>
      _update(ref.read(updateTtsSettingsUseCaseProvider).updateVoice(voiceName));
