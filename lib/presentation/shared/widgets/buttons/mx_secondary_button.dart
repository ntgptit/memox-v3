...
class MxSecondaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget? leading = icon == null ? null : Icon(icon, size: SizeTokens.iconSm);
    final Widget child = switch (variant) {
      MxSecondaryVariant.tonal => leading == null
          ? FilledButton.tonal(onPressed: onPressed, style: style, child: Text(label))
          : FilledButton.tonalIcon(onPressed: onPressed, style: style, icon: leading, label: Text(label)),
      MxSecondaryVariant.outlined => leading == null
          ? OutlinedButton(onPressed: onPressed, style: style, child: Text(label))
          : OutlinedButton.icon(onPressed: onPressed, style: style, icon: leading, label: Text(label)),
      MxSecondaryVariant.text => leading == null
          ? TextButton(onPressed: onPressed, style: style, child: Text(label))
          : TextButton.icon(onPressed: onPressed, style: style, icon: leading, label: Text(label)),
    };
  ...
  ButtonStyle _styleFor(MxSecondaryVariant variant) {
    final double horizontal =
        variant == MxSecondaryVariant.text ? SpacingTokens.md : SpacingTokens.xl;
    return ButtonStyle(
